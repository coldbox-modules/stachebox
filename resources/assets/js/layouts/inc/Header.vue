<template>
  <header
    class="flex justify-between items-center py-4 px-6 bg-gray-100 pt-5 pb-5 border-b-2 border-gray-800"
  >
    <div class="flex items-center">
      ...
      <div class="relative mx-4 lg:mx-0">
        ...
        <input
          class="form-input w-32 sm:w-64 rounded-md pl-10 pr-4 focus:border-teal-600"
          type="text"
          placeholder="Search"
        />
      </div>
